...
void main() {
  /* Chapter 4: Control Flow
    ...
    1) Boolean Values
      const bool yes = true; 
      const bool no = false;
      const yes = true;  //Dart inference
      const no = false;  //Dart inference
    ...
    3) Boolean Logic
      ...
      - order that Dart uses to evaluate expressions containing comparison and logical operators
        1) !
        2) >= > <= <
        3) == != 
        4) && 
    ...
    9) Enumerated types
      ...
      - Enumerated types, also known as enums , play especially well 
      ...
      - placing it outside of the main function:
        ...
        //it’s customary to write the enum name with an initial capital 
          letter, as Weather 
        //The values of an enum should use lowerCamelCase unless 
    ...
    Mini-exercises
      ...
      2)enum AudioState 
        {   // put this outside of the main function.
          playing,
          paused,
          stopped,
        }
